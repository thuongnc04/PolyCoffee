...
i18n
    ...
    .init({
        resources,
        lng: "en",
        ns: ['home', 'product', 'favourite', 'cart', 'order', 'orderdetail', 'history', 'profile', 'setting', 'register', 'login', 'language', 'menu'],
        fallbackLng: "vi",
        interpolation: {
            escapeValue: false // Đảm bảo an toàn từ XSS khi sử dụng react
        }
    });
